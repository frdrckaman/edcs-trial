...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('edc_theme', '0008_auto_20210127_1004'),
    ]

    operations = [
        migrations.CreateModel(
            name='HistoricalEdcsTheme',
            fields=[
                ...
                ('theme', models.CharField(choices=[('dark', 'Dark Theme'), ('light', 'Light Theme')], default='light', max_length=8, verbose_name='EDC Theme')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('user', django_currentuser.db.models.fields.CurrentUserField(blank=True, db_constraint=False, default=django_currentuser.middleware.get_current_authenticated_user, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'historical edcs theme',
